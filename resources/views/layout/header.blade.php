...
<div >
    <a href="https://www.instagram.com"><img src="{{asset('img/instagram.svg')}}" alt="" width="100px" height="100px"></a>
    <a href="https://web.telegram.org"><img src="{{asset('img/telegram.svg')}}" alt="" width="100px" height="100px"></a>
</div>
<nav>
    <ul>
        @if($user and $user->isAdmin())
